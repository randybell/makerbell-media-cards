// bell-keypress-card.js v0.5.1
// MakerBell Media Cards - Single Key Button

(function waitForBellMedia() {
  if (!window.BellMedia || !window.BellMedia.API) {
    setTimeout(waitForBellMedia, 50);
    return;
  }
  ...
  console.info('%c BELL-KEYPRESS-CARD %c v0.5.1 ', 'background:#e8952f;color:#fff;font-weight:bold;', 'background:#333;color:#fff;');
})();